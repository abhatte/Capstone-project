...
The following description of the analysis is given without the complete R code, which can be found on my [**GitHub repository**](https://github.com/abhatte/Capstone-project/blob/master/source/diabetes.R).
...
* The model 2 has an accuracy rate of 79% which is better than our baseline model with accuracy 61%
...
This suggests that the activities represented by these codes are responsible for Hypoglycemia.

******

# Discussions

* Based on our results, we can reccommend to patients to not to take insulin dose right after the exercise as blood glucose is already below normal.
